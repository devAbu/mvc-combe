...
<head>
    ...
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta.2/css/bootstrap.min.css" integrity="sha384-PsH8R72JQ3SOdhVi3uxftmaW6Vc51MKb0q5P2rRUpPvrszuE4W1povHYgTpBfshb" crossorigin="anonymous">  <link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">    
  ...
  <button onclick="w3_close()" class="w3-bar-item w3-large">Close &times;</button>
   <header>
    ...
    <aside style="float:right; margin-right:30px;">
        ...
        <input type="date" style="width:270px; margin-bottom:15px;" name="checkIn" id="checkIn" min="2018-01-01" max="2020-01-01" required> <br>
        ...
        <input type="number" placeholder="Number of adults" id="adultNum" name="adultsNum" style="width:399px;" class="form-control bfh-number" onchange="checkPrice();"> <br>
        <input type="number" placeholder="Number of children" id="childNum" name="childrenNum" class="form-control bfh-number" onchange="checkPrice();" style="width:399px;"> <br>
        <center>
            <input type="number" id="totalPrice" name="price" placeholder="Price" readonly class="form-control bfn-number" style="width:100px;">
        </center>
        <br>
...
<?php 
    ...
    <section >
        ...
        <a href="skyBar">Sky Bar</a>
        <img src="images/hotel.jpg" alt="BG" style="width:100%; height:300px;"> 
    </section>

    <article>
        <h2 style="margin-top:30px;margin-left:50px;">NEKI NASLOV</h2>
        <p style="max-width:500px;margin-left:50px;">The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from "de Finibus Bonorum et Malorum" by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.</p>
        <label style="margin-left:50px;">SHARE </label>
        <a href="https://facebook.com">
        ...
        <p style="max-width:500px; margin-top:-200px; margin-left:850px;" >The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from "de Finibus Bonorum et Malorum"</p>
        <p style="margin-left:850px;">Follow us on <a href="https://www.facebook.com"><img src="images/facebook.png" alt="Facebook" style="margin-left:15px;  width:70px; height:40px;"></a></p>
    </article>

    <aside style="margin-top:150px;margin-left:50px;">
        <p style="max-width:450px;">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source. Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of "de Finibus Bonorum et Malorum" (The Extremes of Good and Evil) by Cicero, written in 45 BC. This book is a treatise on the theory of ethics, very popular during the Renaissance. The first line of Lorem Ipsum, "Lorem ipsum dolor sit amet..", comes from a line in section 1.10.32.</p>
    </aside>

    <img src="images/hotel.jpg" alt="NEKA SLIKA" style="width:550px; height:300px; margin-left:750px; margin-top:-400px;">
    <br>
    <img src="images/" alt="SLIDESHOW" style="margin-bottom:50px;">

    <article>
        <label>You might also like: </label>
        <input type="button" value="SWIMMING IN THE SKY POOL" style="margin-left:610px; margin-top:-35px;width:450px;" class="btn btn-outline-danger btn-lg"> <br>
        <input type="button" value="LUNCH UNDER THE ..." style="margin-left:750px;width:450px;" class="btn btn-outline-danger btn-lg" >
    </article>
