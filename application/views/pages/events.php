  ...
  <button onclick="w3_close()" class="w3-bar-item w3-large">Close &times;</button>
   <header>
    ...
    <aside style="float:right; margin-right:30px;">
        ...
        <center>
        <input type="number" placeholder="Price" id="totalPrice" name="price" readonly class="form-control bfh-number" style="width:100px;">
        </center>
        <br>
...
<?php 
        ...
        <input type="button" value="CONFERENCES & MEETINGS" class="btn btn-primary btn-lg">
        <input type="button" value="PRIVATE CEREMONIES & PARTIES" class="btn btn-primary btn-lg">
        <hr>
    </header>
    ...
    <input type="button" value="PRIVATE CEREMONIES & PARTIES" class="btn btn-outline-dark btn-lg" style="margin-top:50px;height:200px; width:550px; margin-left:50px;">
    <br>
    <input type="button" value="CONFERENCES & MEETINGS" style="margin-top:50px; margin-left:750px;width:550px;height:200px;" class="btn btn-outline-dark btn-lg">
